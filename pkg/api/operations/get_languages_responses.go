...
func (o *GetLanguagesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /languages] GetLanguages", response, response.Code())
	}
}
...
func (o *GetLanguagesOK) Error() string {
	...
	return fmt.Sprintf("[GET /languages][%d] getLanguagesOK %s", 200, payload)
}
...
/*
GetLanguagesOKBodyItems0 get languages o k body items0
swagger:model GetLanguagesOKBodyItems0
*/
type GetLanguagesOKBodyItems0 struct {
...
// Validate validates this get languages o k body items0
func (o *GetLanguagesOKBodyItems0) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateLongCode(formats); err != nil {
		res = append(res, err)
	}
...
func (o *GetLanguagesOKBodyItems0) validateCode(formats strfmt.Registry) error {
...
func (o *GetLanguagesOKBodyItems0) validateLongCode(formats strfmt.Registry) error {

	if err := validate.Required("longCode", "body", o.LongCode); err != nil {
		return err
	}
...
func (o *GetLanguagesOKBodyItems0) validateName(formats strfmt.Registry) error {
...
func (o *GetLanguagesOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res GetLanguagesOKBodyItems0
